...
export default function App() {
  ...
  return <main className="app-shell">
    ...
    {isShared && sharedList?.market && <div className="setup-notice"><Share2 size={15} /> Churrasco compartilhado - edicao anonima ativa. Compartilhe o link com a turma.{visitorCode ? ` Você é o visitante ${visitorCode}.` : ''}</div>}
