...
export default function App() {
  ...
  const [noListWarn, setNoListWarn] = useState(false);
  ...
  // Código do visitante anônimo: primeiros 6 do uid (confere na console do Firebase).
  const visitorCode = user?.uid ? String(user.uid).slice(0, 6).toUpperCase() : null;
